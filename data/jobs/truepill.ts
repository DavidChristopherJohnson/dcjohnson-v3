...
export const TruepillJob: IJob = {
    ...
    jobInfo: {
        ...
        achievements: ["Delivered a new online pharamacy platform (http://costplusdrugs.com) including creating the architectural design that supported 2m+ unique visitors per week",
            ...
            "The company was not in the secure financial state that they advertised when starting",
        ...
        reasonForLeaving: ["Decided to move on after the company got into financial difficulty"],
        skills: [
            "Leadership",
            "Line Management",
