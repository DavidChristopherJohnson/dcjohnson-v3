...
export const HeliosXJob: IJob = {
    ...
    jobInfo: {
        ...
        achievements: ["Implemented knowledge transfer of SCRUM, agile wasy of working, estimation and velocity tracking, resulting in consistent delivery of commitments week on week. This also increased the frequency of deliverables, and improving the internal reputation of the engineering team.",
            "As intermin product owner, I re-prioritised items on the product roadmap resulting in delivery of revenue generating initiatives sooner that boosted revenue by ~$12,000 per month.",
