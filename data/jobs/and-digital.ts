...
export const ANDJob: IJob = {
    ...
    jobInfo: {
        ...
        achievements: ['Led the solution design and technical delivery of a front end (angular 2) decision tree application for StepChange Debt Charity, resulting in on schedule delivery, at a high level of quality and customer satisfaction.',
            ...
            'Trained junior engineers on programming best practises, resulting in a lift in the average skill level of software engineers within the Halifax club.',
            'Advised engineers on SCRUM and Agile ways of working, resulting in engineers being able to on-board to client with less friction.',
