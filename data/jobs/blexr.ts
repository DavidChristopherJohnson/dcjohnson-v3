...
export const BlexrJob: IJob = {
    ...
    jobInfo: {
        ...
        achievements: ["Implemented SCRUM in all teams within my tribes which resulted in a better understanding of velocity and capability, leading to more accurate estimates and a reputation boost in terms of delivery for the team.",
            ...
            "Acted as Head of Engineering and Principal Engineer due to lack of a personnel, ensuring that there was adequate leadership from within the team to function, in the absence of dedicated personnel with these roles.",
            ...
            "Designed a solution to allow content to increase the pace of new market launches further, by automating parts of the market cloneing functionality, which when implemented, will result in decreasing the time it takes the content team spend create content for new markets across the company.",
