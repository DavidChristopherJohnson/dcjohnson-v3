  ...
  return (
    <div className="w-full min-h-screen text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="w-full flex flex-grow-1 max-sm:flex-col gap-8">
          <div className="sm:min-w-80 max-sm:max-w-60 max-sm:self-center space-y-4">
            ...
            <div className="flex flex-col gap-3">
              <Link href='/cv' className="text-center">
                <button className="w-full bg-blue-700 hover:bg-blue-800 text-white px-6 py-3 rounded-md transition-all duration-300 text-lg font-medium">
                  View CV
                </button>
              </Link>
              <button className="w-full border border-white/30 px-6 py-3 rounded-md text-white hover:text-blue-400 hover:border-blue-400 transition-colors duration-300 text-lg">
                Download CV
              </button>
            </div>
          </div>

          <div className="flex-grow-1 space-y-8">
            <div className="border border-white/10 rounded-lg p-6 md:p-8 transition-colors duration-300 hover:border-blue-500/60 hover:shadow-md">
              <p className="text-gray-300 text-lg">
                My name is David Christopher Johnson. I am a {age}-year-old technologist, leader, mentor, husband and father. I currently live in Dewsbury, United Kingdom, with my wife and two amazing kids
              </p>
            </div>
            
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-white">Life Long Goal</h2>
              <div className="border border-white/10 rounded-lg p-6 md:p-8 transition-colors duration-300 hover:border-blue-500/60 hover:shadow-md space-y-4">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-white">Engineering Background</h2>
              <div className="border border-white/10 rounded-lg p-6 md:p-8 transition-colors duration-300 hover:border-blue-500/60 hover:shadow-md space-y-4">
                <p className="text-gray-300">
            ...
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-white">Personal Life</h2>
              <div className="border border-white/10 rounded-lg p-6 md:p-8 transition-colors duration-300 hover:border-blue-500/60 hover:shadow-md space-y-4">
                <p className="text-gray-300">
                ...
                <p className="text-gray-300">
                  ...
                  or at the <a className='text-blue-400 hover:text-blue-300 transition-colors duration-300 font-bold' href='https://www.facebook.com/groups/wakefieldboardgamegroup' rel='nofollow no-referrer'>Wakefield Board Gaming Group&apos;s</a> weekly meet-up 
